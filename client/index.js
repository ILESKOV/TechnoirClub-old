...
// var contract = "0x1a9340838014459Dcc6e904Ed25D6359bf940737";
// var contractOwner;
...
//   var idStr = getId();
//   instance.methods.createRobotGeneration0(idStr).send({}, function(error, txHash){
//       if(error)
//          console.log(err);
//       else
//           console.log(txHash);
...
var instance;
var user;
var contractAddress = "0x1a9340838014459Dcc6e904Ed25D6359bf940737";
...
$(document).ready(function(){
    window.ethereum.enable().then(function(accounts){
        ...
        instance.events.Build().on('data', function(event){
            console.log(event);
            let owner = event.returnValues.owner;
            ...
            $("#robotCreation").css("display", "block");
            $("#robotCreation").text(" owner: " + owner
                                    +" robotId: " + robotId
                                    +" firstRobotParentId: " + firstRobotParentId
                                    +" secondRobotParentId: " + secondRobotParentId
                                    +" id: " + id)
        }).on('error', console.error);
    })
})
