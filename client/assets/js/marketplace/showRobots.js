...
function removeSelection(id, firstOrSecond) {
    ...
    var selectionDiv = `<div align="center">
                                ...
                                <h4>Select a robot as `+ firstOrSecond + `</h4>
                            </div>
                        </div>`
...
function idRobot(idStr) {
    ...
    var id = {
        //Colors
        "element1Color": idStr.substring(0, 2),
        "element2Color": idStr.substring(2, 4),
        "element3Color": idStr.substring(4, 6),
        "element4Color": idStr.substring(6, 8),
        //Attributes
        "eyesShape": idStr.substring(8, 9),
        "decorationPattern": idStr.substring(9, 10),
        "element5Color": idStr.substring(10, 12),
        "element6Color": idStr.substring(12, 14),
        "animation": idStr.substring(14, 15),
        "lastNum": idStr.substring(15, 16)
    }
...
function robotBox(id) {
    ...
    var robotDiv = `<div class="col-lg-4 pointer fit-content" id="robotview` + id + `">
                 <div class="featureBox robotDiv">
                 `+ robotBody(id) + `                           
                 </div>
                 <div class="idDiv" id="robotId`+ id + `"></div>
                 `+ attributes(id) + `
                </div>`
...
var single =    ` <div id="head`+ id + `" class="head">
                  <div id="mouth`+ id + `" class="mouth"></div>
                  <div id="eyes`+ id + `" class="eyes movingEyes">
                   <span class="eye`+ id + ` left_eye">
                       <aside class="pupils`+ id + `">
                         <section id="pupils2`+ id + `" class="pupils2"></section>
                       </aside>
                    </span>
                   <span class="eye`+ id + ` right_eye">
                       <aside class="pupils`+ id + `">
                         <section id="pupils3`+ id + `" class="pupils2"></section>
                       </aside>
                   </span>
                  </div>
                </div>
               ...
               <div id="body`+ id + `" class="body">
                <div class="body_decoration">
                  <div id="chest`+ id + `" class="chest left_chest">
                    <div class="nipple"></div>
                  </div>
                  <div id="chest1`+ id + `" class="chest right_chest">
                    <div class="nipple"></div>
                  </div>
                </div>
               </div>      
               ...
               <div class="hands">                        
                <div class="tricepses">
                  <div id="triceps`+ id + `" class="triceps right_triceps"></div>
                  <div id="triceps1`+ id + `" class="triceps left_triceps">
                    <div id="decor2`+ id + `" class="decor2">
                      <div class="decor3"></div>
                    </div>
                  </div>
                </div>
                <div class="bicepses">
                  <div id="biceps`+ id + `" class="biceps right_biceps"></div>
                  <div id="biceps1`+ id + `" class="biceps left_biceps"></div>
                </div>
                <div class="shoulders">
                  <div id="shoulder`+ id + `" class="shoulder right_shoulder"></div>
                  <div id="shoulder1`+ id + `" class="shoulder left_shoulder"></div>
                </div>
                <div class="forearms">
                  <div id="forearm`+ id + `" class="forearm right_arm">
                   <div id="decor1`+ id + `" class="decor1"></div>
                   <div class="fingers">
                     <div id="finger`+ id + `" class="finger finger_R"></div>
                     <div id="finger`+ id + `" class="finger finger_R"></div>
                     <div id="finger`+ id + `" class="finger finger_R"></div>
                   </div>
                  </div>
                  <div id="forearm1`+ id + `" class="forearm left_arm">
                   <div class="fingers">
                     <div id="finger`+ id + `" class="finger finger_L"></div>
                     <div id="finger`+ id + `" class="finger finger_L"></div>
                     <div id="finger`+ id + `" class="finger finger_L"></div>
                   </div>
                  </div>
              ...
              <div class="legs">
                <div id="leg`+ id + `" class="leg right_leg">
                  <div class="fingers">
                    <div id="finger`+ id + `" class="finger finger_leg_R"></div>
                    <div id="finger`+ id + `" class="finger finger_leg_R"></div>
                    <div id="finger`+ id + `" class="finger finger_leg_R"></div>
                  </div>
                </div>
                <div id="leg1`+ id + `" class="leg left_leg">
                  <div class="fingers">
                    <div id="finger`+ id + `" class="finger finger_leg_L"></div>
                    <div id="finger`+ id + `" class="finger finger_leg_L"></div>
                    <div id="finger`+ id + `" class="finger finger_leg_L"></div>
                  </div>
                </div>
              ...
              <div id="decoration`+ id + `" class="decoration">
                <section id="robot_scheme`+ id + `" class="robot_scheme">
                 <aside id="robot_scheme1`+ id + `" class="robot_scheme1">
                   <span id="robot_scheme2`+ id + `" class="robot_scheme2"></span>
                 </aside>
               </section>
               </div>`
    return single
...
function attributes(id) {
    ...
    var Attributes = `<ul class="ml-5 attributes" style="color: antiquewhite;">
                            <li><span id="eyeName`+ id + `"></span></li>
                            <li><span id="decorationName`+ id + `"></span></li>
                            <li>With <span id="animationName`+ id + `"></span></li>
                       </ul>`
    return Attributes
