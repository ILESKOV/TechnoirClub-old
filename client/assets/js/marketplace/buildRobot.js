...
function element1Color(code, id) {
    ...
    $('#triceps' + id +', #triceps1' + id + ', #head' + id + ', #forearm' + id + ', #forearm1' + id+ ', #shoulder' + id+ ', #shoulder1' + id + ', #leg' + id + ', #leg1' + id + ', #biceps' + id + ', #biceps1' + id).css('background', '#' + color)
}
...
function normalEyes(id) {
    ...
    "margin": "19px", "background-color": "rgb(238, 238, 238)",
    "position": "relative", "border": "3px solid black"})
    $('.eye' + id).find('aside').css({"border-radius": "50%", "width": "19px", "height": "30px",
    "background-color": "#101111", "position": "relative",
    "top": "9px", "left": "7px"})
    $('.pupils' + id).find('section').css({"width": "9px", "height": "7px", "border-radius": "31%",
    "position": "relative", "top": "12px", "left": "1px"})
}

function eyes2(id) {
    $('#eyes' + id).find('span').css({"border-radius": "25%", "height": "18px", "background-color": "rgb(255 68 68)"})
    $('.eye' + id).find('aside').css({"border-radius": "33%", "width": "17px", "height": "13px", 
    "top": "0", "left": "5px"})
    $('.pupils' + id).find('section').css({"width": "7px", "height": "5px", "top": "4px", "left": "3px"})
}

function eyes3(id) {
    $('#eyes' + id).find('span').css({"height": "37px", "background-color": "rgb(155, 27, 27)"})
    $('.eye' + id).find('aside').css({"border-radius": "100% 100% 0% 0%", "width": "31px", "height": "13px",
    "top": "0", "left": "0"})
    $('.pupils' + id).find('section').css({"width": "9px", "height": "7px", "border-radius": "31%",
    "top": "14px", "left": "11px"})
}
...
function eyes4(id) {
    $('#eyes' + id).find('span').css({"height": "44px", "background-color": "rgb(6 6 7)"})
    $('.eye' + id).find('aside').css({"background-color": "rgb(6 6 7)"})
    $('.pupils' + id).find('section').css({"width": "5px", "height": "4px", "top": "7px", "left": "6px"})
}

function eyes5(id) {
    $('#eyes' + id).find('span').css({"border-radius": "35%", "height": "33px", "background-color": "#822029"})
    $('.eye' + id).find('aside').css({"width": "20px", "height": "15px", "top": "7px", "left": "5px"})
    $('.pupils' + id).find('section').css({"width": "4px", "height": "7px", "border-radius": "31%", "top": "4px", "left": "7px"})
}

function eyes6(id) {
    $('#eyes' + id).find('span').css({"border-radius": "25%", "height": "44px", "background-color": "rgb(186 182 182)"})
    $('.eye' + id).find('aside').css({"width": "30px", "height": "13px", "top": "13px", "left": "0px"})
    $('.pupils' + id).find('section').css({"border-radius": "100%", "top": "3px", "left": "13px"})
}

function eyes7(id) {
    $('#eyes' + id).find('span').css({"height": "13px", "background-color": "rgb(255 0 0)"})
    $('.eye' + id).find('aside').css({"width": "0px", "height": "0px"})
    $('.pupils' + id).find('section').css({"width": "6px", "height": "6px", "top": "-9px", "left": "5px"})
}

function eyes8(id) {
    $('#eyes' + id).find('span').css({"height": "38px"})
    $('.eye' + id).find('aside').css({"top": "1px", "left": "11px", "width": "21px", "height": "30px"})
    $('.pupils' + id).find('section').css({"left": "9px"})
}

function eyes9(id) {
    $('#eyes' + id).find('span').css({"height": "38px", "border-radius": "38%"})
    $('.eye' + id).find('aside').css({"top": "2px", "left": "1px", "border-radius": "38%", "width": "28px", "height": "28px"})
...
function normaldecoration(id) {
    ...
    $('#robot_scheme1' + id).css({"width": "43px", "height": "2px", "background-color": "#101111", 
                                                "border": "1px solid black", "position": "absolute", "left": "-2px", 
                                                "z-index": "1", "top": "34px", "transform": "rotate(0deg)"})
    $('#robot_scheme2' + id).css({"width": "2px", "height": "72px", "background-color": "#101111", 
                                                "border": "1px solid black", "position": "absolute", "left": "36px", 
                                                "z-index": "1", "border-radius": "0 0 50% 50%", "top": "0px",
...
function decoration2(id) {
    ...
    $('#robot_scheme2' + id).css({"height": "31px", "left": "7px", "top": "103px",
...
function decoration4(id) {
    ...
    $('#robot_scheme1' + id).css({"transform": "rotate(90deg)", "top": "123px",
                                                "left": "-14px", "width": "31px" })
