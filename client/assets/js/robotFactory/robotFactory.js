...
async function normalEyes() {
    await $('.eyes').find('span').css({"border-radius": "50%", "width": "38px", "height": "53px",
                                       "margin": "19px", "background-color": "rgb(238, 238, 238)",
                                       "position": "relative", "border": "3px solid black"})
    await $('.eye').find('aside').css({"border-radius": "50%", "width": "19px", "height": "30px",
                                       "background-color": "#101111", "position": "relative",
                                       "top": "9px", "left": "7px"})
    await $('.pupils').find('section').css({"width": "9px", "height": "7px", "border-radius": "31%",
...
async function eyes2() {
    ...
    await $('.eye').find('aside').css({"border-radius": "33%", "width": "17px", "height": "13px", 
                                       "top": "0", "left": "5px"})
...
async function eyes3() {
    ...
    await $('.eye').find('aside').css({"border-radius": "100% 100% 0% 0%", "width": "31px", "height": "13px",
                                       "top": "0", "left": "0"})
    await $('.pupils').find('section').css({"width": "9px", "height": "7px", "border-radius": "31%",
                                            "top": "14px", "left": "11px"})
}
...
async function eyes5() {
    ...
    await $('.pupils').find('section').css({"width": "4px", "height": "7px", "border-radius": "31%", "top": "4px", "left": "7px"})
}

async function eyes6() {
    await $('.eyes').find('span').css({"border-radius": "25%", "height": "44px", "background-color": "rgb(186 182 182)"})
...
async function eyes9() {
    ...
    await $('.eye').find('aside').css({"top": "2px", "left": "1px", "border-radius": "38%", "width": "28px", "height": "28px"})
...
async function normalDecoration() {
    ...
    await $('.robot_scheme').find('aside').css({"width": "43px", "height": "0px", "background-color": "#101111", 
                                                "border": "1px solid black", "position": "absolute", "left": "-2px", 
                                                "z-index": "1", "top": "34px", "transform": "rotate(0deg)"})
    await $('.robot_scheme1').find('span').css({"width": "0px", "height": "72px", "background-color": "#101111", 
...
async function decoration2() {
    ...
    await $('.robot_scheme1').find('span').css({"height": "31px", "left": "7px", "top": "103px",
...
async function decoration4() {
    ...
    await $('.robot_scheme').find('aside').css({"transform": "rotate(90deg)", "top": "123px",
...
async function decoration8() {
    ...
    await $('.robot_scheme1').find('span').css({"transform": "rotate(82deg)", "height": "81px", "left": "79px", "top": "50px"})
}
